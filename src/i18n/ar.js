...
export const ar = {
    ...
    guide: {
        ...
        steps: {
            ...
            channels: {
                title: 'القنوات',
                text: 'حين تتابع القنوات التي تثق بها، يصلك جديدها في «اليوم» و«اكتشف». ولك أيضًا أن تُنشئ قناتك وتنشر فيها.',
            },
            voice: {
    ...
    legal: {
        ...
        lastUpdatedDate: '25 سبتمبر 2026',
        ...
        footer: {
            ...
            viewerIdOff: 'إيقاف معرّف عدّ المشاهدات',
            viewerIdOn: 'تشغيل معرّف عدّ المشاهدات',
            ...
            sections: [
                ...
                },
                {
                    ...
                    bullets: [
                        ...
                        'أيام القراءة — كم تقدّمتَ في كلّ كتاب في كلّ يوم، ليُحسَب ما قرأتَه هذا الأسبوع. تُحفَظ ثلاثين يوماً ثم تُحذَف تلقائياً، وتُمسَح مع سجل القراءة.',
                ...
                },
                {
                    ...
                    paragraphs: [
                        ...
                        'ولا يدخل في هذا كوكي ولا معرّف إعلاني ولا بصمة جهاز. والشيء الوحيد الذي يُحفظ في متصفّحك لهذا الغرض رقمٌ عشوائي، وغرضه الوحيد ألّا تُعدّ مشاهدتك مرتين؛ وليس فيه شيء عنك ولا عن جهازك، ولا يُستعمل في غير العدّ.',
                    ...
                    bullets: [
                        ...
                        'وإن كنت زائراً بلا حساب حفظ متصفّحك رقماً عشوائياً يُنشأ فيه أول مرة، لا يُشتقّ منك ولا من جهازك، ويبقى ثلاثة عشر شهراً ثم يُستبدَل. لا يُرسَل إلا مع طلب فتح فيديو أو كتاب أو مقال، فتُحسب لك مشاهدة واحدة للعنصر ولو عدت إليه في يوم آخر. ولا يُخزَّن الرقم نفسه عندنا، وإنما ناتجُ تعميةٍ له لا يُردّ إليه.',
                        'وإلى جانبه مفتاحٌ يومي: بصمةُ تعميةٍ لتاريخ اليوم وعنوانِ IP ونوعِ المتصفّح، يتغيّر كل يوم. ولا تُحسب المشاهدة إلا إن كان المفتاحان جديدين معاً، حتى لا يكفي تغييرُ الرقم وحده لتضخيم العدّاد.',
                        'ولك أن توقف الرقم في أي وقت من «إيقاف معرّف عدّ المشاهدات» أسفل الصفحة، فيُمحى من متصفّحك ويُعدّ بالمفتاح اليومي وحده. ومسحُ بيانات الموقع من متصفّحك يمحوه كذلك.',
                ...
                },
                {
                    ...
                    paragraphs: [
                        ...
                        'وإنما تستعمل التخزين المحلي في متصفّحك، لأمور تخصّ متصفّحك وحده ولا تصل إلينا: رمزِ دخولك بعد تسجيل الدخول، واختيارِك الوضع الفاتح أو الداكن، ولغةِ الواجهة، وجوابِك عن عرض فيديوهات يوتيوب، وسرعةِ التشغيل ومستوى الصوت اللذين ضبطتهما في المشغّل، وأنّك رأيتَ دليل الموقع فلا يُفتح لك ثانيةً، ورقماً عشوائياً لعدّ المشاهدات إن لم تكن مسجّل الدخول (انظر «كيف يُحسب عدّاد المشاهدات»)، وحالةِ رفعٍ لم يكتمل حتى تستأنفه.',
