            ...
            sections: [
                ...
                },
                {
                    ...
                    paragraphs: [
                        ...
                        'وإنما تستعمل التخزين المحلي في متصفّحك، لأمور تخصّ متصفّحك وحده ولا تصل إلينا: رمزِ دخولك بعد تسجيل الدخول، واختيارِك الوضع الفاتح أو الداكن، ولغةِ الواجهة، وجوابِك عن عرض فيديوهات يوتيوب، وسرعةِ التشغيل ومستوى الصوت اللذين ضبطتهما في المشغّل، وأنّك رأيتَ دليل الموقع فلا يُفتح لك ثانيةً، وحالةِ رفعٍ لم يكتمل حتى تستأنفه.',
                        'والاستثناء الوحيد لغةُ الواجهة: إن كنت مسجّل الدخول نُسخت إلى حسابك، لتصلك رسائل الحساب بلغتك.',
