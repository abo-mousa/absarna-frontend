...
export const ar = {
    ...
    today: {
        ...
        welcome: {
            ...
            signInWhy: 'بحساب في أبصرنا يمكنك أن تتابع القنوات، وأن تجد هنا تتمّة ما بدأت وما أنجزته كل أسبوع.',
            ...
            sections: [
                ...
                },
                {
                    ...
                    bullets: [
                        ...
                        'ولا ترشيحَ يقيس زمنَ بقائك ليطيله: صفحة «اليوم» لها آخِر، ولا تشغيلَ تلقائياً لفيديو بعد فيديو. وما أنهيتَ مشاهدته قد يُقترَح لك بسببه ما يشبهه، ويُذكَر لك ذلك صراحةً؛ أمّا ما فتحتَه ولم تُتمّه فلا يُبنى عليه اقتراح.',
                    ],
                },
            ],
        },
            ...
            sections: [
                ...
                },
                {
                    ...
                    paragraphs: [
                        ...
                        'ومنهما تُبنى صفحة «اليوم»: الحلقةُ التالية من برنامج بدأته، وموضعُ توقّفك في كتاب، وما أنهيتَه هذا الأسبوع، واقتراحاتٌ تشبه آخرَ فيديو أنهيتَ مشاهدته يُذكَر لك اسمُه معها. ولا يُبنى اقتراحٌ على فيديو فتحتَه ولم تُتمّه، ولا يُرتَّب به شيءٌ في صفحة «اكتشف»، وإنما يُحذَف منها ما شاهدتَه.',
                    ],
                    bullets: [
