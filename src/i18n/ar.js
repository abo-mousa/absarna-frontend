...
export const ar = {
    ...
    legal: {
        ...
        lastUpdatedDate: '15 سبتمبر 2026',
            ...
            sections: [
                ...
                },
                {
                    ...
                    paragraphs: [
                        ...
                        'ويُرسَل البريد عبر خدمة Resend، وهي جهة خارجية تتولّى التسليم نيابةً عنا، فيصلها عنوان بريدك واسمك المعروض ونصّ الرسالة. ولا يصلها شيء آخر عن حسابك ولا عن نشاطك.',
                ...
                },
                {
                    ...
                    paragraphs: [
                        'هذه قائمة الجهات الخارجية التي يتعامل معها النظام، وهي كلّ ما هناك. وليست فيها شبكة إعلانات، ولا بوابة دفع، ولا أداة تحليلات خارجية.',
                    ],
                    bullets: [
                        'Hetzner — الخوادم التي يعمل عليها الموقع، وقاعدة البيانات.',
                        'Cloudflare — تخزين ملفات الفيديو والكتب وتقديمها للقرّاء، وإدارة نطاق الموقع.',
                        'Resend — تسليم رسالتَي التفعيل وإعادة تعيين كلمة المرور.',
