...
import { Home, Compass, MessageSquareText, Bell, History, Bookmark, Plus, Settings } from 'lucide-react';
        ...
        <>
            ...
            >
                <div className="px-2 mb-4">
                    ...
                    <Link to="/posts" onClick={onClose} className={navLinkClass(isActive('/posts'))}>
